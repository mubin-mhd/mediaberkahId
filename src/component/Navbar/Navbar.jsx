      ...
      <nav className="shadow-sm bg-[#FACC15] shadow-[#FACC15]">
        <div className="flex relative  justify-between px-2 lg:px-4 py-2.5 w-full md:w-11/12 lg:w-10/12 mx-auto">
          ...
          <div className="flex items-center mr-5">
            <a className="md:flex items-center w-min hidden mr-4">
              ...
              <div className="flex justify-center">
                <div>
                  <div className="dropdown relative">
                    <button
                      className="dropdown-toggle px-3 py-2 font-semibold ml-3 bg-[#4BAA32] text-white text-md leading-tight uppercase rounded shadow-md hover:shadow-lg  focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-md transition duration-150 ease-in-out flex items-center whitespace-nowrap"
                      type="button"
                      id="dropdownMenuButton1"
                      data-bs-toggle="dropdown"
                      aria-expanded="false"
                    >
                      <i className="bi bi-book text-lg font-semibold flex items-center text-white mr-2"></i>{" "}
                      Al Qur'an
                      <svg
                        aria-hidden="true"
                        focusable="false"
                    ...
                    <ul
                      className="dropdown-menu min-w-max absolute bg-white text-base  z-50 float-left list-none text-left rounded-lg shadow-lg mt-1 hidden m-0 bg-clip-padding border-none"
                      aria-labelledby="dropdownMenuButton1"
                    >
                      <Link to="/quran">
                        <li className="dropdown-item text-sm py-2 px-4  block w-full whitespace-nowrap bg-transparent text-gray-700 hover:bg-gray-100 font-base">
                          Surah & Terjemahan
                        </li>
                      </Link>
                    </ul>
